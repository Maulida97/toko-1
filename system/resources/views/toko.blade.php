...
<body>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="90">
        <a href="#1"><img src="{{url('public')}}/gambar/1.jpg" class="d-block w-100" alt="gambar 1"></a>
      </div>
      <div class="carousel-item">
        <img src="{{url('public')}}/gambar/3.jpg" class="d-block w-100" alt="gambar 2">
      </div>
      <div class="carousel-item">
        <img src="{{url('public')}}/gambar/4.jpg" class="d-block w-100" alt="gambar 3">
      </div>
    </div>
