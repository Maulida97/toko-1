		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{url('beranda')}}"><img src="{{url('public')}}/img/logo.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="{{url('public')}}/index.html">Home</a></li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false">Shop</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/category.html">Shop Category</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/single-product.html">Product Details</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/checkout.html">Product Checkout</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/cart.html">Shopping Cart</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/confirmation.html">Confirmation</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/login.html">Login</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/tracking.html">Tracking</a></li>
									<li class="nav-item"><a class="nav-link" href="{{url('public')}}/elements.html">Elements</a></li>
								</ul>
							</li>
							<li class="nav-item"><a class="nav-link" href="{{url('public')}}/contact.html">Contact</a></li>
						</ul>
			...
			<div class="row justify-content-center">
					...
					<div class="row">
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<a href="{{url('public')}}/img/category/c1.jpg" class="img-pop-up" target="_blank">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<a href="{{url('public')}}/img/category/c2.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Sneaker for Sports</h6>
									</div>
								</a>
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<a href="{{url('public')}}/img/category/c3.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
						...
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<a href="{{url('public')}}/img/category/c4.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Sneaker for Sports</h6>
									</div>
								</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-deal">
						...
						<a href="{{url('public')}}/img/category/c5.jpg" class="img-pop-up" target="_blank">
							<div class="deal-details">
								<h6 class="deal-title">Sneaker for Sports</h6>
							</div>
						</a>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="{{url('public')}}/{{url('public')}}/img/product/p1.jpg" alt="">
				...
				<div class="col-lg-6 no-padding exclusive-right">
					<div class="active-exclusive-product-slider">
						...
						<div class="single-exclusive-slider">
							<img class="img-fluid" src="{{url('public')}}/img/product/e-p1.png" alt="">
							<div class="product-details">
								<div class="price">
									<h6>$150.00</h6>
									<h6 class="l-through">$210.00</h6>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{url('public')}}/s/nouislider.min.js"></script>
